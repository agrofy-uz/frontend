        ...
        >
          <Card radius="xl" shadow="xl" withBorder p={0}>
            ...
            <Stack p="md" gap="md">
              ...
              <Grid mt="lg">
                {[
                  { label: t('home.hero.mockup.stats.humidity'), value: '68%' },
                  { label: t('home.hero.mockup.stats.temp'), value: '24°C' },
                  { label: t('home.hero.mockup.stats.wind'), value: '12 km/h' },
                ].map((stat, index) => (
            ...
            <Stack p="md" gap={6}>
              ...
              >
                <Group gap="xs">
                  ...
                  <Text size="xs" fw={500}>
                    {t('home.hero.mockup.mobile.aiName')}
                  </Text>
                </Group>
              </motion.div>
              ...
              >
                <Text size="xs" c="dimmed">
                  {t('home.hero.mockup.mobile.cropHealth')}
                </Text>
              </motion.div>
            </Stack>
          </Card>
